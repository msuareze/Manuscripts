...
class tree: ## tree class
 ...
 #   	print([w.name for w in self.Objects if w.branchType=='leaf'])
...
#        print([w.numName for w in self.Objects if w.branchType=='leaf'])
        if numName==True:
    ...
    def collapseSubtree(self,cl,givenName,verbose=False,widthFunction=lambda x:x):
        ...
        remove_from_tree=set(remove_from_tree)
